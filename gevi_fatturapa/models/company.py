...
class ResCompany(models.Model):
    ...
    fatturapa_tel = fields.Char("FPA Telefono")
    fatturapa_fax = fields.Char("FPA Fax")
    fatturapa_email = fields.Char("FPA e-mail")

    fatturapa_trasmittente = fields.Char("ID Trasmittente", help="Nel formato IT01879020517")
    ...
    fatturapa_rea_provincia = fields.Char(
        related="partner_id.rea_provincia", string='REA Provincia')
...
class AccountConfigSettings(models.TransientModel):
    ...
    fatturapa_tel = fields.Char("FPA Telefono", related='company_id.fatturapa_tel')
    fatturapa_fax = fields.Char("FPA Fax", related='company_id.fatturapa_fax')
    fatturapa_email = fields.Char("FPA e-mail", related='company_id.fatturapa_email')

    fatturapa_trasmittente = fields.Char("FPA ID Trasmittente", help="Nel formato IT01879020517",
                                         related='company_id.fatturapa_trasmittente')
    ...
    fatturapa_rea_provincia = fields.Char(
        related="company_id.fatturapa_rea_provincia", string='REA Provincia')
    fatturapa_rea_office = fields.Many2one(
